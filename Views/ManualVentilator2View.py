...
class ViewVentilator2(Frame):
    class Constants:
        title = "Toggle Ventilator"
        text = "Control Manual Ventilator 2"
        center = N + S + E + W
        label_size = 40
        toggle_size = 20
    ...
    def __init__(self, parent, change_view_handler = None, tap_handler = None):
        ...
        label = Label(self, text=self.Constants.text, bg="black", fg="white",
                      font=(self.Constants.font, self.Constants.label_size))
        ...
        button1 = Button(self, text = self.Constants.text_button_back,font = (self.Constants.font, self.Constants.label_size),
